...
/**
 * iOS风格SwitchButton，支持开关的"延时和回滚"操作
 * @author https://github.com/iielse/SwitchButton
 */
public class SwitchButtonView extends View {
    ...
    public SwitchButtonView(Context context, AttributeSet attrs) {
        ...
        colorShadow = a.getColor(R.styleable.SwitchButtonView_shadowBgColor, 0xFF333333);
        colorBar = a.getColor(R.styleable.SwitchButtonView_barColor, 0xFFFFFFFF);
        colorBackground = a.getColor(R.styleable.SwitchButtonView_bgColor, 0xFFFFFFFF);
