...
/**
 * Android 自带阻尼效果的ScrollView,仿iOS回弹效果
 */
public class MyScrollViewSlidingRebound extends ScrollView {
    ...
    public MyScrollViewSlidingRebound(Context context) {
        super(context);

    }

    public MyScrollViewSlidingRebound(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyScrollViewSlidingRebound(Context context, AttributeSet attrs, int defStyle) {
