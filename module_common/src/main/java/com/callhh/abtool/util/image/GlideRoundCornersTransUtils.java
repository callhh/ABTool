package com.callhh.abtool.util.image;
...
/**
 * Glide 4.7.1版本对指定角加载圆角
 */
public class GlideRoundCornersTransUtils extends BitmapTransformation {
    ...
    public GlideRoundCornersTransUtils(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public GlideRoundCornersTransUtils(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof GlideRoundCornersTransUtils &&
                ((GlideRoundCornersTransUtils) o).radius == radius &&
                ((GlideRoundCornersTransUtils) o).diameter == diameter &&
                ((GlideRoundCornersTransUtils) o).margin == margin &&
                ((GlideRoundCornersTransUtils) o).cornerType == cornerType;
    }
